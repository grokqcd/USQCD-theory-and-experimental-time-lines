...
% Rajan Gupta
\subsection{Contributions of CP violating operators to nucleon electric dipole moment (nEDM)}\label{sec:nEDM}
\begin{itemize}
    \item[Motivation.] The CP violation in the CKM quark mixing is too
      ...
      systematics. Kmowng these matrix elements, one can use the bound
    ...
    \item[Long term goal.] To calculate the matrix elements of all low energy effective operators of dimension six
...
\item[Timeline:]
    \item[Pre 2017] The first lattice calculations set up the framework but did not include a phase in the definition of the 
    ...
    \item[2021-2023] Calculations from a number of collaboration for the Theta term with different levels of 
      control over signal and systematics. 
    \item[2023-2025] To get a robust signal at near physical quark masses. 
    \item[2030] Expect a factor of 10 reduction in the upper bound on neutron EDM and mabe a value. 
\end{itemize}
