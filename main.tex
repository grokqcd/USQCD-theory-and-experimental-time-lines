...
\section{The QCD $\Lambda$ parameter and the  strong coupling constant at the Z-pole}
\begin{itemize}
...
\section{Composite Higgs Models}
...
\section{Cosmic Frontier}

\subsection{Anomalies in Galaxy Formation}
...
\subsection{Space-based Gravitational Wave Detection}
...
\subsection*{Lattice supersymmetry}
\begin{itemize}
   \item{ \bf Motivation:}
...
with a finite number of colors \cite{Catterall:2020lsi}. 
   \item{\bf Timeline:}
   \begin{itemize}
   \item There is now ongoing work using an optimized parallel code based on the 
MILC codebase. This code is publicly available.
    \item variety of calculations in the near future -- from computations of the anomalous
dimension of the Konishi operator to tests of S duality and explorations of the Coulomb branch of
the theory are planned 
\end{itemize}
\end{itemize}

\subsection*{Quantum field theories on hyperbolic space.}
...
\subsection*{Exact lattice anomalies and new mirror models}
