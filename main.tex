...
B    \item[2021] E989 announces first results with 0.48 ppm precision. Combined with BNL 821 (0.54 ppm), yields 4.2 standard deviation discrepancy with theory.
...
%\begin{itemize}
    ...
    \item[2022] Precise calculation of $|V_{cs}|$ with a QCD error comparable to the current experimental precision and of $|V_{cd}|$ with a QCD error twice that of experiment~\cite{FermilabLattice:2022gku}.
    \item[2024] Calculation of $|V_{ub}|$ to 1\% via $B\to D\ell\nu$ and $|V_{ub}$ to 2\% via $B\to \pi\ell\nu$.
    \item[2024] Calculation of $B\to\pi \ell^+\ell^-$ and $B\to K \ell^+\ell^-$ to 2\%.
    \item[2026] LHCb End of Run 3 data taking. Beginning of Long shutdown 3.
    \item[2027] Calculation of $|V_{cb}|$ to the sub-percent level via $B\to D^*\ell\nu$.
    \item[2027] Calculation of $R(D*)$ to 1\%.
    \item[2027-28] Belle II Long shutdown 2.
%    \item[??] Belle II
%    \item[??] LHCb
%    \item[??] BES III
%\end{itemize}
...
%\begin{itemize}
    ...
    \item[2025] Possible Phase III GlueX run.
...
\begin{itemize}
    ...
    \item[Method.] Combines QCD spectroscopy program and hadronic
...
\begin{itemize}
    \item[Motivation.] Experimental $N^\ast$ program in CLAS12@JLab,
    ...
    \item[Long term goal.] Fully resonance calculations of decay
      couplings of possible states, including potential hybrid baryon
      states identified through transition form-factors.
    \item[Method.] 
  \item[Timeline:]
    \item[2012] Initial calculations of light and strange quark baryon
      spectrum using single particle operators~\cite{Edwards:2011jj,Dudek:2012ag,Edwards:2012fx}.
    \item[2023] Meson-baryon coupled channel determination of a few
      low lying light quark resonances.
    \item[2024] Coupled channel low lying hyperon resonances.
    \item[2025] Potential charm-light quark baryon resonances.
\end{itemize}
...
\item[Timeline:]
    \item[2011--2019] Lattice results reach the robustness standard to be reviewed by FLAG and average values published.
    ...
    \item[2030] Much higher precision analysis of neutron decay that
...
\begin{itemize}
    \item[Motivation.] Studying the 3D-structure of hadrons and understanding the partonic origin of hard exclusive processes are among the goals of the Jefferson Lab 12 GeV program and the future Electron-Ion Collider (EIC). The pion and kaon, as the pseudo-Goldstone modes of QCD, play a critical role in understanding the physics of asymptotic freedom and chiral symmetry-breaking in QCD from the fundamental quark-gluon interactions.
    
    \item[Long term goal.] First principles calculations of the pion and kaon distribution amplitudes and form factors with large momentum transfer to explore the transition from non-perturbative QCD to perturbative QCD. Precision calculations of the pion valence quark PDFs and GPDs, providing insights into the quark momentum fractions and 3-dimensional distributions in the pseudo-Goldstone bosons.
    
    \item[Method.] Calculation of pion/kaon form factors in the Breit frame with optimized quark smearing to achieve large momentum transfers. Computation of the pion quasi-DA, PDF, GPD and kaon quasi-DA matrix elements with large momentum, and deriving the light-cone quantities using large momentum effective theory and short distance factorization.
      
\item[Timeline:]
    \item[2019] Calculation of the pion valence quark distribution with a 300 MeV pion mass from a fine lattice within the LaMET framework.~\cite{Izubuchi:2019lyk}
    \item[2020] Calculation of the pion valence quark distribution with a continuum extrapolation using the LaMET and short distance factorization frameworks.~\cite{Gao:2020ito}
    \item[2021] Calculation of the structural differences between the pion and its radial excitation.~\cite{Gao:2021hvs}
    \item[2021] Calculation of the pion form factors and charge radius with small momentum transfer at the physical point.~\cite{Gao:2021xsm}
    \item[2022] Calculation of the pion distribution amplitude at the physical point within the short distance factorization framework.~\cite{Gao:2022vyh}
    \item[2022] Calculation of the Bjorken-x dependence of the pion valence PDF with controlled systematics.~\cite{Gao:2021dbh}
    \item[2022] Calculation of the pion valence PDF with a continuum extrapolation, physical quark masses and NNLO matching.~\cite{Gao:2022iex}
    \item[2023] Calculation of the kaon distribution amplitude at the physical point.
    \item[2023] First calculation of the pion form factors at the physical point with large momentum transfer.
    \item[2024] First calculation of the kaon form factors at the physical point with large momentum transfer.
    \item[2025] Calculation of pion GPDs with a 300 MeV pion mass.
    \item[2027] Calculation of pion GPDs at the physical point.
...
\item[Timeline:]
   ...
   \item[2022]Combined global analysis of lattice QCD and
...
\begin{itemize}
    \item[Motivation.] The gravitational form factors (GFF) of the
    ...
    \item[Long term goal.] Provide Standard Model predictions of the
    ...
    \item[Method.] Lattice calculations with grid source propagators
      ...
      operators.  
\item[Timeline:]
    \item[2021] Lattice calculation of nucleon energy-momentum tensor
...
\begin{itemize}
    \item[Motivation.] The formalism of hadronic tensor in lattice
    ...
    \item[Long term goal.] Calculate precise neutrino-nucleon
    ...
    \item[Method.]  Calculation of matrix elements using four-point
      ...
      Minkowski space. 
    \item[Timeline:]
    \item[1993,1999] The hadronic tensor was formulated in the
  ...
  \item[2017] The parton evolution equation is generalized to include
    the connected-sea partons~\cite{Liu:2017lpe}. 
    \item[2019] First exploratory calculation of the hadronic tensor
    ...
    \item[2020] Plenary talk at 2019 Lattice Conference which checked
    ...
    \item[2020] It is shown that the parton degrees of freedom from
      the hadronic tensor are the same as those in the quasi- and
      pseudo-PDFs~\cite{Liu:2020okp}. 
    \item[2021] The connected-sea partons have been incorporated in
      the global analysis of PDFs for the first
      time~\cite{Hou:2022ajg}
    \item[2023] Calculation of nucleon elastic and $N\to N^*$
...
\begin{itemize}
	\item[Motivation.]  The most precise lattice determination of
          ...
          toward  this goal. 
	\item[Long term goal.] The QCD strong coupling $\alpha_s$, as
          ...
          long-term goal. 
	\item[Method.]  The application of gradient flow based
          ...
          technology.  
	\item[Timeline:]
	\item[2012] The LatHC collaboration introduces the gradient
          ...
          models.  
	\item[2017-2018] The LatHC collaboration introduces and tests
          ...
          \cite{Fodor:2017die}.  
	\item[2019-2020] The new paradigm was extended to predict the
	...
	\item[2022-2023] In the SU(3) Yang-Mills limit of quenched QCD
          ...
          method. 
	\item[2023-2024]  Ongoing and future work of two USQCD groups
...
\begin{itemize}
\item[Motivation.] Gauge theories with massless fermions and large
  ...
  window. 
  \item[Method.] The effective field theory description of this
...
\item[Timeline:]
   \item[2018-2020] The LatHC collaboration presents dilaton effective
     ...
     collaboration.
   \item[2023-2024] There are ongoing tests in the sextet model and in
...
\begin{itemize}
   ...
   \item[Method.] In recent years the continuous $\beta$ function
...
\item[Timeline:] 
   ...
   \item[2023-2025] First published result for $N_f=2$ is expected in
     2023, followed by more precise calculations for both $N_f=2$ and
     3. 
